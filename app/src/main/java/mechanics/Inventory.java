...
public class Inventory {
    ...
    public Inventory() {
        ...
        Item sticks = new Item("sticks", 0, 10, 1, true, null, null, null, 0, 0, 0, 1, 5,  5,   10, 1, 1);
        Item rocks = new Item ("rocks",  0, 10, 1, true, null, null, null, 0, 0, 0, 1, 5,  10,  20, 1, 1);
        Item hide = new Item  ("hide",   0, 10, 1, true, null, null, null, 0, 0, 0, 2, 6,  20,  40, 1, 1);
        Item clay = new Item  ("clay",   0, 10, 1, true, null, null, null, 0, 0, 0, 2, 8,  30,  80, 1, 1);
        Item metal = new Item ("metal",  0, 10, 1, true, null, null, null, 0, 0, 0, 3, 10, 40, 120, 1, 1);
        Item oil = new Item   ("oil",    0, 10, 1, true, null, null, null, 0, 0, 0, 3, 10, 50, 160, 1, 1);
        Item paper = new Item ("paper",  0, 10, 1, true, null, null, null, 0, 0, 0, 1, 6,  60, 200, 1, 1);

        // Create Craftable Items in the Inventory
        Item spear = new Item ("spear",  0, 10, 1, true, "sticks", "rocks", null,     2,  1,  0,  5, 15,  10,  10, 1, 1);
        Item sword = new Item ("sword",  0, 10, 1, true, "sticks", "metal", null,     1,  3,  0,  8, 25,  20,  40, 1, 1);
        Item brick = new Item ("brick",  0, 10, 1, true, "clay",   null,    null,     5,  0,  0,  5, 20,  30,  60, 1, 1);
        Item house = new Item ("house",  0, 10, 1, true, "sticks", "brick", "hide",  10, 30,  8, 40, 90, 100, 200, 1, 1);
        Item castle = new Item("castle", 0, 10, 1, true, "sticks", "rocks", "metal", 30, 60, 10, 40, 90, 200, 400, 1, 1);
        Item lamp = new Item  ("lamp",   0, 10, 1, true, "metal",  "oil",   null,     1,  1,  0,  3,  6,  40,  80, 1, 1);
        Item book = new Item  ("book",   0, 10, 1, true, "paper",  "hide",  null,     5,  2,  0,  3,  6,  50, 100, 1, 1);
    ...
    public int howManyCanCraft(Item item) {
        ...
        if (req1 != null) {
            ...
            if (item.getMax() < item.getCount() + numCraftableItems) {
                numCraftableItems = item.getMax() - item.getCount();
            }
